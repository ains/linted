...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'linted.repository': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'88efa960-8158-4010-82f1-85359151639e'", 'unique': 'True', 'max_length': '40'})
        },
        ...
        u'linted.repositoryscan': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'repository': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linted.Repository']"}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f48b115d-9c0d-43f2-94f0-c00f2dd22591'", 'unique': 'True', 'max_length': '40'})
        },
