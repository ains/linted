...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'linted_errorgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linted.ErrorGroup'])),
    ...
    models = {
        ...
        u'linted.errorgroup': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linted.ErrorGroup']"})
        },
        u'linted.language': {
        ...
        u'linted.repository': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fefbc81e-131a-4cd4-9850-2afd5691bfa1'", 'unique': 'True', 'max_length': '40'})
        },
