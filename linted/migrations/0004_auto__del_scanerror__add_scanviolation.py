...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ScanError'
        db.delete_table(u'linted_scanerror')
        ...
        db.create_table(u'linted_scanviolation', (
            ...
            ('previous_error', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linted.ScanViolation'])),
    ...
    def backwards(self, orm):
        # Adding model 'ScanError'
        db.create_table(u'linted_scanerror', (
            ('snippet', self.gf('django.db.models.fields.TextField')()),
            ('end_line', self.gf('django.db.models.fields.IntegerField')()),
            ('previous_error', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linted.ScanError'])),
            ('file', self.gf('django.db.models.fields.TextField')(max_length=256)),
            ('scan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linted.RepositoryScan'])),
            ('start_line', self.gf('django.db.models.fields.IntegerField')()),
            ('linter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['linted.Linter'])),
        ...
        db.send_create_signal(u'linted', ['ScanError'])
    ...
    models = {
        ...
        u'linted.repository': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6af56076-410b-4ebb-92b6-cf23e8659331'", 'unique': 'True', 'max_length': '40'})
        },
        ...
        u'linted.scanviolation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linter': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linted.Linter']"}),
            'previous_error': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['linted.ScanViolation']"}),
